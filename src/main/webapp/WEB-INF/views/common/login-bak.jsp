...
<shiro:authenticated>
    <script type="text/javascript">window.top.location.href = "${basepath}/common/index.do";</script>
</shiro:authenticated>
<!DOCTYPE html>
...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var tag = '${tag}';
            if (tag != "refreshed") {
                window.top.location = "${basepath}/common/login.do?tag=refreshed&msg=${msg}&userName=${userName}";
            }
